...
export const BLOG_POSTS: Record<string, BlogPost> = {
  "upstep-is-open-source": {
    slug: "upstep-is-open-source",
    title: "Upstep is now open source",
    description:
    ...
    body: [
      {
        type: "p",
        text: "Today we are opening the Upstep repository. The dashboard, feedback API, public roadmaps, integrations, billing, web and mobile SDKs, deployment setup, and the MCP server are all there. You can inspect the code, run the product on your own infrastructure, change it, and contribute back.",
      },
      {
        type: "links",
        links: [
          { label: "View Upstep on GitHub", href: "https://github.com/TheBugEater/upstep" },
          { label: "Read the self-hosting guide", href: "https://github.com/TheBugEater/upstep#quick-start" },
        ],
      },
      { type: "h2", text: "Why open source a feedback product?" },
      {
        type: "p",
        text: "Feedback is one of the most valuable datasets a product team owns. It contains unfinished plans, customer pain, internal decisions, and a fairly honest map of where the product is weak. Asking a team to put all of that into a black box requires trust. We would rather earn that trust with code you can inspect and an exit path you control.",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "The server is licensed under AGPL-3.0. The independently distributed SDK and shared-type packages remain MIT licensed, so application developers can embed them without inheriting the server license.",
      },
      { type: "h2", text: "A security boundary we wanted to get right" },
      {
        type: "p",
        text: "Opening the code also gave us a reason to make the credential model explicit. Publishable SDK keys start with upstep_pk_ and are designed to live in browser and mobile applications. Private MCP keys start with upstep_mcp_, grant project-scoped read and write access, are shown once, and are stored only as SHA-256 digests. A public client key is never treated as an authorization boundary for private project data.",
      },
      { type: "h2", text: "How Upstep remains a business" },
      {
        type: "p",
        text: "Open source does not mean the hosted product disappears. Most teams do not want to operate a database, migrations, OAuth, email delivery, billing webhooks, backups, and notification workers for a feedback widget. Upstep Cloud remains the fastest way to use the product, with a free plan and paid plans for teams that need more capacity and support.",
      },
      {
        type: "p",
        text: "The business model is straightforward: the software is available, and we charge for the convenience and reliability of running it for you. We think that is a healthier incentive than hiding basic product capabilities behind a proprietary wall.",
      },
      { type: "h2", text: "Run it yourself" },
      {
        type: "code",
        lang: "bash",
        code: "git clone https://github.com/TheBugEater/upstep.git\ncd upstep\ncp apps/web/.env.example apps/web/.env\ndocker compose up --build",
      },
      {
        type: "p",
        text: "Upstep runs as one application backed by PostgreSQL. Redis is not required. The repository includes committed Prisma migrations, a dependency-free health endpoint, a production startup script, and documentation for OAuth, email, Stripe, SDKs, and the REST API.",
      },
      { type: "h2", text: "What we want from the community" },
      {
        type: "p",
        text: "Try it, question the decisions, and tell us where the self-hosting path is rough. Contributions to SDKs, integrations, accessibility, documentation, and deployment targets are especially welcome. If you find a security issue, please use the private reporting process in SECURITY.md rather than opening a public issue.",
      },
      {
        type: "links",
        links: [
          { label: "Star or fork the repository", href: "https://github.com/TheBugEater/upstep" },
          { label: "Read the contribution guide", href: "https://github.com/TheBugEater/upstep/blob/main/CONTRIBUTING.md" },
        ],
      },
    ],
  },
...
(function () {
  ...
  "public-roadmaps-are-not-promises": {
    slug: "public-roadmaps-are-not-promises",
    title: "A public roadmap is not a promise. It is a conversation.",
    description: "The useful version of a public roadmap shows direction, lets customers contribute evidence, and makes room for product discovery.",
    date: "2026-07-13",
    tag: "Product management",
    readMinutes: 5,
    body: [
      { type: "p", text: "The fear around public roadmaps is understandable: publish a list, and someone will interpret every item as a delivery date. The answer is not to hide all direction. It is to make the roadmap honest about what it knows and what it does not." },
      { type: "h2", text: "Direction is more useful than false precision" },
      { type: "p", text: "Early product work changes as customers respond, dependencies appear, and a seemingly small request turns out to be a larger system change. A date attached too early does not create certainty; it only turns discovery into a broken promise." },
      { type: "p", text: "A simple Now, Next, Later view is usually enough. Now means active work. Next means validated work whose ordering can still change. Later means an area worth watching, not a commitment." },
      { type: "h2", text: "Publish outcomes, not implementation tickets" },
      { type: "list", items: ["Good: Let teams control who can access a workspace.", "Too internal: Add role middleware to the workspace route.", "Good: Make it easier to export the data customers need.", "Too vague: Improve exports."] },
      { type: "p", text: "Customers care about the problem that will be solved. Engineering tasks, investigations, and security work should remain on the internal board. Keeping that boundary makes the public view smaller and much easier to maintain." },
      { type: "h2", text: "Votes make it a conversation" },
      { type: "p", text: "A roadmap gets more useful when people can add context to it. Votes help reveal repeated demand, while comments and follow-up questions explain the job a customer is trying to do. They are evidence, not a referendum: product strategy, customer impact, and effort still matter." },
      { type: "h2", text: "The maintenance is the product" },
      { type: "p", text: "A modest roadmap that is reviewed every month builds more trust than a beautiful one updated twice a year. Move shipped work promptly, explain meaningful changes in direction, and archive items that are no longer relevant. That visible rhythm tells customers that giving feedback is worth their time." },
      { type: "p", text: "We made a free Now, Next, Later roadmap template for teams that want a low-stakes place to start. Once the pattern is working, Upstep can turn that plan into a live feedback board with votes and status updates." },
    ],
  },
  "why-feedback-needs-a-triage-rhythm": {
    slug: "why-feedback-needs-a-triage-rhythm",
    title: "Feedback is not a backlog until someone reviews it",
    description: "A lightweight weekly triage rhythm turns scattered requests into product evidence without turning the team into a support desk.",
    date: "2026-07-13",
    tag: "Workflow",
    readMinutes: 6,
    body: [
      { type: "p", text: "Most teams do not have a feedback problem. They have a review problem. Requests arrive through support, sales calls, chats, app-store reviews, and someone’s memory. Without a regular moment to look at them together, the loudest request becomes the backlog." },
      { type: "h2", text: "The weekly thirty-minute review" },
      { type: "p", text: "A useful first cadence is one owner, one short weekly block, and a small set of decisions. New items get classified. Duplicates get grouped. Requests missing context get a follow-up. The team decides what deserves a deeper product conversation. The goal is not to promise a decision on every item." },
      { type: "h2", text: "Classify before scoring" },
      { type: "p", text: "Bugs, feature requests, and general comments should not all be compared in the same way. A widespread broken workflow may need immediate attention with one vote. A proposed feature needs evidence about who needs it, what outcome it creates, and what it costs to build." },
      { type: "list", items: ["Bug: impact, severity, affected customers, workaround.", "Feature: reach, outcome, strategic fit, effort, and confidence.", "General feedback: themes, sentiment, and clues for future research."] },
      { type: "h2", text: "Duplicates are signal, not clutter" },
      { type: "p", text: "Five differently worded requests may describe the same customer problem. Keep the useful context from each report, but center votes around one canonical request. That makes demand visible without requiring someone to read the same request five times." },
      { type: "h2", text: "Close the loop deliberately" },
      { type: "p", text: "When a request ships, update its status and say what changed. When it is not planned, explain the trade-off where appropriate. Customers do not expect every idea to win; they do notice whether anyone listened." },
      { type: "p", text: "Our full feedback-triage guide includes a simple status model, follow-up questions, decision framework, and release loop that a small product team can run without adding another meeting." },
    ],
  },
  "embedded-feedback-beats-a-blank-email": {
    slug: "embedded-feedback-beats-a-blank-email",
    title: "Why embedded feedback gets better product signal than a blank email",
    description: "Collecting feedback where customers are already working preserves context, reduces duplicate requests, and gives teams evidence they can prioritize.",
    date: "2026-07-13",
    tag: "Product",
    readMinutes: 5,
    body: [
      { type: "p", text: "A support email address is better than silence, but it asks a customer to leave the moment of friction, compose a message from scratch, and hope it reaches the right person. Most people will not do that for a small annoyance. The feedback you receive is therefore skewed toward the loudest or most patient customers." },
      { type: "h2", text: "Context disappears quickly" },
      { type: "p", text: "The best time to capture a bug report or feature idea is when the customer is looking at the thing that caused it. An in-product launcher gives them a clear action without sending them to a separate forum, a long survey, or an empty email composer." },
      { type: "h2", text: "Existing requests should be visible" },
      { type: "p", text: "A blank form makes every customer describe the same problem again. Showing a voting board before or alongside submission lets people find an existing request, vote for it, and add context only when theirs is genuinely different. That creates a better demand signal than an inbox full of near-identical threads." },
      { type: "h2", text: "The integration should not become a project" },
      { type: "p", text: "Upstep is designed to mount in the client you already ship: JavaScript for web apps, a provider and bottom sheet for React Native, and a Flutter widget for mobile. All of those clients can write to the same feedback board, so a customer’s platform does not fragment the product conversation." },
      { type: "h2", text: "Use identity responsibly" },
      { type: "p", text: "A stable internal user ID is useful for vote deduplication and support context. It should not become an excuse to send more personal data than the feature needs. Use an opaque account identifier, document the behavior, and keep authentication and payment secrets outside the client SDK." },
      { type: "p", text: "If you are ready to add feedback to a product, start with the Next.js, React Native, or Flutter guide. The setup is intentionally small; the important work is what your team does with the signal once it arrives." },
    ],
  },
};
