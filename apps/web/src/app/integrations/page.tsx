...
export const metadata: Metadata = {
  ...
  description:
    "Drop the Upstep feedback widget into React, Next.js, Vue, Svelte, Astro, WordPress, Shopify, React Native, Flutter, Expo, and more. Plus a built-in MCP server so your AI agent can triage what comes in.",
    ...
    <div className="min-h-screen bg-canvas">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <p className="text-lg text-muted leading-relaxed max-w-2xl mb-14">
          A typed React SDK, a framework-agnostic script for everything else, and native
          React Native plus Flutter packages for mobile. Pick your platform below, then connect the{" "}
