      ...
      <main className="max-w-3xl mx-auto px-6 py-16 sm:py-24">
        ...
        <div className="prose-upstep">
          <Section title="1. Acceptance">
            <p>
              By creating an account or using Upstep (&ldquo;the
              Service&rdquo;), you agree to these Terms of Service
              (&ldquo;Terms&rdquo;). If you don&rsquo;t agree, please
          ...
          <Section title="3. Acceptable use">
            ...
            <ul>
              <li>
                Use the Service to collect feedback on behalf of people who
                haven&rsquo;t consented.
              </li>
              <li>Submit abusive, illegal, or misleading content.</li>
              <li>
                Attempt to reverse-engineer, scrape, or abuse the API beyond its
                intended use.
              </li>
              <li>
          ...
          <Section title="4. Plans, payment &amp; billing">
            <p>
              The Free plan is available to all users at no cost. Paid plans
              (Pro, Business) are billed monthly through Stripe. You can cancel
              at any time from the Billing page; your plan remains active until
              the end of the current billing period, after which it reverts to
              Free. We reserve the right to change pricing with 30 days&rsquo;
              notice.
            </p>
          </Section>
          ...
          <Section title="5. Your data">
            <p>
              You retain ownership of all feedback data collected through your
              projects. We process it only to provide the Service. You can
              delete your projects and data from the dashboard at any time.
            </p>
          </Section>

          <Section title="6. Service availability">
            <p>
              We aim for high availability but make no guarantees of uptime or
              uninterrupted access. We may perform maintenance, update the
              Service, or suspend access to fix issues without prior notice.
            </p>
          </Section>
          ...
          <Section title="8. Termination">
            <p>
              ...
              terminate your account if you violate these Terms, with or without
              notice. Upon termination, your data will be retained for 30 days
          ...
          <Section title="10. Changes to these Terms">
            <p>
              ...
              dashboard. Continued use after changes constitutes acceptance.
            </p>
          </Section>
